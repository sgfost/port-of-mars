...
import { Role, ChatMessageData } from "@port-of-mars/shared/types";
import { GameRequestAPI } from "@port-of-mars/client/api/game/request";
import ChatMessage from "@port-of-mars/client/components/game/static/chat/ChatMessage.vue";

@Component({
  components: {
    // use Webpack async import to resolve circular dependency
    ChatMessage: () => import("@port-of-mars/client/components/game/static/chat/ChatMessage.vue"),
  }
})
